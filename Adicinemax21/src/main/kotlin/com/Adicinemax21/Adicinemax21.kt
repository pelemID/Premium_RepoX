...
open class Adicinemax21 : TmdbProvider() {
    ...
    override val mainPage = mainPageOf(
        ...
        "$tmdbAPI/discover/movie?api_key=$apiKey&with_original_language=id&without_genres=16,10749&sort_by=popularity.desc&primary_release_date.gte=2020-01-01" to "Indonesian Movies (2020+)",
